...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>We provide all the essential services you need in one place. TV, internet, home phone, mobile
                        services, cable, and easy bill payments. Our goal is to make your life easier by offering reliable
                        and affordable solutions for your everyday needs.</p>
                    <ul>
                        <li><i class="bi bi-check2-circle"></i> <span>We provide secure and hassle free options for paying
                                your bills.</span></li>
                        <li><i class="bi bi-check2-circle"></i> <span>Our goal is to make your life easier with reliable
                                digital services.</span></li>
                        <li><i class="bi bi-check2-circle"></i> <span>We understand the importance of staying connected in
                                today’s world.</span></li>
                    </ul>
                </div>

                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <p>With our experience in the industry, we understand how important it is to stay connected. That’s why
                        we offer fast internet, clear calling, great TV packages, and secure payment options, all designed
                        to fit your lifestyle and budget.</p>
                    <p>We work hard to give you the best service, with no hidden fees and quick support whenever you need
                        it. Whether you’re at home, at work, or on the go, we help you stay connected with ease.</p>
                    <p>At the core of everything we do is a simple promise: We make your digital life easier, more reliable,
                        and stress-free. Your satisfaction is what drives us every day.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-4">
                <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
                    <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p>We make digital living easier by offering all essential services under one roof. Whether it's
                            internet, TV, mobile, or bill payments. We deliver fast, affordable, and reliable solutions with
                            excellent customer support. Our goal is your satisfaction and convenience.</p>
                    </div>
                    <div class="faq-container px-xl-5" data-aos="fade-up" data-aos-delay="200">
                        <div class="faq-item faq-active">
                            <h3><span>01</span>All-in-One Convenience</h3>
                            <div class="faq-content">
                                <p>We provide TV, internet, phone, mobile, and bill payment services, all in one place, so
                                    you don’t need to manage multiple providers.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Our high-speed internet and clear voice connections ensure you stay connected without
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>We offer competitive pricing with no hidden fees. What you see is what you pay simple,
                                    honest, and fair.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
                ...
                <div class="col-lg-5 order-1 order-lg-2 why-us-img">
                    <img src="{{ asset('landingPage/assets/img/why-us.png') }}" class="img-fluid" alt="" data-aos="zoom-in"
                        data-aos-delay="100">
                </div>
            </div>
        </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <p class="fst-italic">We are experts in delivering reliable, fast, and user-friendly digital services.
                        Our team is skilled in providing seamless solutions that keep homes and businesses connected with
    ...
    <section id="services" class="services section light-background">
        <div class="container section-title" data-aos="fade-up">
            <h2>Services</h2>
            <p>We provide a full range of telecom and utility services, including TV, high-speed internet, home phone, and
                mobile plans, all in one place. From cable setups to secure bill payments, we make it easy and convenient.
                Whether you're switching providers or setting up a new service, we’re here to help with fast support and
                trusted options.</p>
        </div>
        ...
        <div class="container">
            <div class="row" data-aos="zoom-in" data-aos-delay="100">
                <div class="col-xl-9 text-center text-xl-start">
                    ...
                    <p>Need internet, TV, phone, or mobile services? We’re here to help! Get started today with easy,
                        affordable, and reliable solutions all in one place. Contact us now to enjoy stress-free service.
                    </p>
                </div>
    ...
    <section id="faq-2" class="faq-2 section light-background">
        <div class="container section-title" data-aos="fade-up">
            ...
            <p>Have questions? We’re here to help! Below are some of the most common questions our customers ask. From
                service details to billing and support, find quick and clear answers to get started with confidence.</p>
        </div>
        <div class="container">
                ...
                <div class="col-lg-10">
                    <div class="faq-container">
                        <div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="faq-content">
                                <p>We offer internet, TV, home phone, mobile plans, cable services, and bill payment
                                    options—all in one place.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
                        ...
                        <div class="faq-item" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="faq-content">
                                <p>Yes! We offer bundle packages so you can combine internet, TV, and phone services at a
                                    discounted price.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
                        ...
                        <div class="faq-item" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="faq-content">
                                <p>You can pay your bills easily through our secure online payment system or visit our
                                    service center.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
                        ...
                        <div class="faq-item" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <div class="faq-content">
                                <p>We provide high-speed internet with different plans to match your needs—perfect for
                                    streaming, working, or gaming.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
                        ...
                        <div class="faq-item" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div class="faq-content">
                                <p>Yes, our friendly support team is available 24/7 to help you with any questions or
                                    issues.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div>
    ...
    <section id="contact" class="contact section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Contact</h2>
            <p>Need help or have a question? Our team is here to assist you with anything related to our services. Whether
                it's about internet, TV, phone, or billing, feel free to reach out. We're just a call or message away!</p>
        </div>
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-7">
                    <form id="contact-form" action="#" method="post" class="php-email-form" data-aos="fade-up"
                        data-aos-delay="200">
                        @csrf
                        <div class="row gy-4">
